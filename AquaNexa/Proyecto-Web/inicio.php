                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/basic.jpg" alt="..." />
                                
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: básico</div>
                                <div class="portfolio-caption-subheading text-muted">Lo mas basico pero efectivo para tus plantas <br><br><br><br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/temp.jpg" alt="..." />
                                
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: Temperatura</div>
                                <div class="portfolio-caption-subheading text-muted">Añade un sensor de temperatura para saber aun mejor las necesidades requeridas de tus queridas plantaciones en cualquier estacion del año<br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/bomb_sound.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: Ultrasonido y bomba</div>
                                <div class="portfolio-caption-subheading text-muted">El guardar agua cerca de las plantas ya no hara que plagas se aprovechen de los recursos, haciendo que puedas irrigar con la bomba y que el ultrasonido se encargue de los molestos insectos <br><br></div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph_temp_sound.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">


                                <div class="portfolio-caption-heading">AquaNexa: ph, temp. y ultrasonido</div>
                                <div class="portfolio-caption-subheading text-muted">Todos los sensores disponibles en un dispositivo, tendras mediciones precisas a la vez que las plagas se alejan de tus cultivos, para quienes quieren cuidar lo maximo posible a sus plantas <br><br></div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/bomb.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: Bomba</div>
                                <div class="portfolio-caption-subheading text-muted">¿Quieres usar al maximo los recursos y regar las plantas con agua no corriente? Añade una bomba y deja que la presion se encargue del trabajo <br><br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">

                                <div class="portfolio-caption-heading">AquaNexa: Medidor PH</div>
                                <div class="portfolio-caption-subheading text-muted">Una de causas de muertes de plantas comun es la acidez de la tierra, con el sensor de ph recibiras avisos de este problema </div>
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/temp_bomb.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: Bomba y temperatura</div>
                                <div class="portfolio-caption-subheading text-muted">Para el cambio de clima, es mejor estar preparado, tendras infomracion de la temperatura a la vez de que puedes ahorrar con agua estancada desde la bomba a presion <br><br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph_bomb_temp.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">AquaNexa: Ph, temperatura y bomba</div>
                                <div class="portfolio-caption-subheading text-muted">No volveras a tener problemas con las mediciones de tus plantas a la vez que ahorras agua con la bomba ¡tus plantas creceran sanas y fuertes! <br><br><br></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/sound.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading"> AquaNexa: Ultrasonido </div>
                                <div class="portfolio-caption-subheading text-muted">Elimina las molestas plagas que atacan a tus plantas usando un sensor ultrasonido sin perjudicar de ninguna forma las plantas <br><br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph_bomb.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">

                                <div class="portfolio-caption-heading">AquaNexa: Ph y bomba</div>
                                <div class="portfolio-caption-subheading text-muted">Reutiliza agua desde recipientes no corrientes sin el miedo de que la acidez de esta misma agua dañe a las plantas <br><br></div>
                            </div>
                        </div>
                        <br>
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph_temp.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">

                                <div class="portfolio-caption-heading">AquaNexa: Ph y <br>temperatura </div>
                                <div class="portfolio-caption-subheading text-muted">Lo mejor en sensores de medicion de plantas ¡Tendras mucha informacion de como estan tus plantas en todo momento! Ideal para quienes quieren darle el mejor cuidado  <br><br></div>
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/ph_bomb_sound.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
